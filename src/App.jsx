...
import MercenaryApplicationList from './pages/Mercenary/pages/MercenaryRec/MercenaryApplicationList';
      ...
      <Router>
        <AppContainer>
          ...
          <Routes>
            ...
            <Route path="/mercenary/recruitment/:id/applications" element={<MercenaryApplicationList />} />
