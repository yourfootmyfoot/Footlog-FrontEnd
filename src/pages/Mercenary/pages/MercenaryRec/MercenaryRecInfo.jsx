...
function MercenaryRecInfo({ recruitment }) {
  ...
  return (
    <div className={`${recStyle.container} mt-0 mb-0`} onClick={handleClick}>
      <div className={`${recStyle.section} mt-2 mb-2`}>
        <h2 className="text-xl font-bold mb-2 text-gray-800">{recruitment.title}</h2>
